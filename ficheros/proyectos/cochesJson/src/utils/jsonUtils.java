...
public class jsonUtils {
  ...
  public static HashMap<String, Persona> LeerListEmpleadoFromJsonFile(String relativePathFile) {
    File ficheroEmpleado = new File(relativePathFile);

    ObjectMapper objectMapper = new ObjectMapper();

    HashMap<String, Persona> listaEmpleados = null;
    try {
      listaEmpleados = objectMapper.readValue(ficheroEmpleado, new TypeReference<HashMap<String, Persona>>() {
      });
    } catch (IOException e) {
